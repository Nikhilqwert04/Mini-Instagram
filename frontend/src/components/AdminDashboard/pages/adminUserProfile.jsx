          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-5 -mt-16 mb-6 text-center sm:text-left">
            ...
            <div className="sm:mb-2 flex flex-col sm:flex-row gap-3 items-center w-full sm:w-auto">
              ...
              <StatefulButton
                ...
                status={actionStatus}
                onReset={() => setActionStatus("idle")}
                disabled={actionStatus !== "idle"}
                loadingText={userData.isBlocked ? "Unblocking..." : "Blocking..."}
                successText="Done!"
                errorText="Error"
                className={`w-full sm:w-auto px-6 py-2.5 rounded-xl text-sm font-bold shadow-lg transition duration-200 flex items-center justify-center gap-2 border-0 ${
                  userData.isBlocked
              ...
              >
                {userData.isBlocked ? "🟢 Unblock Account" : "🚫 Block Account"}
              </StatefulButton>
            </div>
          </div>
